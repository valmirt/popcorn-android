...
class ReceiverActivity : BaseActivity(), ReceiverContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        data?.let { uriData->
            ...
            when {
                uri.contains("/tv") -> mPresenter.getDetailTv(uri.substring(30), language)
                uri.contains("/person") -> mPresenter.getDetailPerson(uri.substring(34), language)
                uri.contains("/movie") -> mPresenter.getDetailMovie(uri.substring(33), language)
            }
        }
    }
    ...
    override fun successResponsePerson(person: Person) = mPresenter.sendDetailPerson(this, person)
